...
export const USER_ROLES = {
  ...
  ADMIN: 'Quản trị viên',                  // Quản trị hệ thống, phân quyền
  
  // Vai trò quản lý thư viện
  LIBRARY_MANAGER: 'Trưởng thư viện',      // Quản lý thủ thư, duyệt đề xuất
  LIBRARIAN: 'Thủ thư',                    // Quản lý mượn/trả, đăng ký độc giả
  
  // Vai trò kế toán
  ACCOUNTING_MANAGER: 'Trưởng phòng kế toán', // Duyệt đề xuất mua, quản lý kế toán
  ACCOUNTANT: 'Nhân viên kế toán',         // Xử lý giao dịch tài chính
  ...
  // Vai trò người dùng
  READER: 'Độc giả'                        // Mượn sách, tìm kiếm
};
