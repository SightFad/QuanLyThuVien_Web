  ...
  const mockFines = [
    {
      ...
      processedBy: "Librarian Nguyễn Thị B",
    ...
    },
    {
      ...
      processedBy: "Librarian Lê Văn C",
    ...
    },
    {
      ...
      status: "paid",
      reason: "Mất sách",
      processedBy: "Librarian Phạm Thị D",
    ...
    },
    {
      ...
      processedBy: "Librarian Nguyễn Văn A",
    ...
    <div className="fine-management">
      ...
      {showFineModal && selectedFine && (
        <div className="modal-overlay" onClick={() => setShowFineModal(false)}>
          <div
            className="modal fine-detail-modal"
          ...
          >
              ...
              <div className="detail-grid">
                ...
                <div className="detail-section">
                  ...
                  <div className="detail-item">
                    ...
                    <span className="value">
                      {formatDate(selectedFine.returnDate)}
                    </span>
                  </div>
                  <div className="detail-item">
                    <span className="label">Ngày thanh toán:</span>
                    <span className="value">
                      {formatDate(selectedFine.paymentDate)}
                    </span>
                  </div>
                </div>
                ...
                <div className="detail-section">
                  ...
                  {selectedFine.paymentMethod && (
                    <div className="detail-item">
                      ...
                      <span className="value">
                        {selectedFine.paymentMethod === "cash"
                          ? "Tiền mặt"
                          : "Chuyển khoản"}
                      </span>
                    </div>
                ...
                <div className="detail-section full-width">
                  ...
                  <div className="detail-item">
                    ...
                    <span className="value">
                      {selectedFine.notes || "Không có ghi chú"}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="modal-actions">
              ...
              <button
                className="btn btn-primary"
                onClick={() => handleEditFine(selectedFine)}
              >
                <FaEdit />
                Chỉnh sửa
              </button>
